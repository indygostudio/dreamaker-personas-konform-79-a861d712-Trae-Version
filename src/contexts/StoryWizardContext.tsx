...
// Utility functions moved from DREAMFRAME
const generateScenesFromStory = (storyline: string, totalDurationInMinutes: number) => {
...
const generatePromptForScene = (description: string) => {
